...
namespace DefaultCreators {
  ...
  export type Clear = (toNull?: boolean) => LeafStandardAction<boolean | undefined>
  ...
  export type Drop = (n?: number) => LeafStandardAction<number | undefined>

  export type Filter<T = any> = (callback: (element: T, index: number, array: T[]) => T[]) => LeafStandardAction<(element: T, index: number, array: T[]) => T[]>

  export type Increment = (n?: number) => LeafStandardAction<number | undefined>
