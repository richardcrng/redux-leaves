...
function actionsCreate<D = LeafReducerDict>(customReducers: D, pathToLeafOrBranch: (string | number)[] = []): LeafCreate<D> {
  ...
  const create = Object.assign<LeafCreateFunction<D>, LeafCreatorAPI<D>>(createFunction, createFunction())
